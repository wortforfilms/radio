...
Generated 2026-07-09T17:29:47.074Z from `apps/radio/registry` — do not edit by hand.
...
| `radio.live` | `/radio/live` | 🟡 partial | player | anonymous | — |
| `radio.now-playing` | `/radio/now-playing` | ✅ built | player | anonymous | — |
| `radio.schedule` | `/radio/schedule` | 🟡 partial | article | anonymous | — |
| `radio.frequencies` | `/radio/frequencies` | ⬜ planned | article | anonymous | — |
| `radio.shows` | `/radio/shows` | 🟡 partial | article | anonymous | — |
| `radio.shows.detail` | `/radio/shows/:slug` | 🟡 partial | article | anonymous | — |
| `radio.rj` | `/radio/rj/:slug` | 🟡 partial | article | anonymous | — |
| `radio.archive` | `/radio/archive` | ✅ built | article | anonymous | — |
| `radio.request` | `/radio/request` | ⬜ planned | article | anonymous | — |
| `radio.dedicate` | `/radio/dedicate` | ⬜ planned | article | anonymous | — |
| `radio.download` | `/radio/download` | 🟡 partial | article | anonymous | — |

## 🎙 Podcast

| id | path | status | layout | permissions | flags |
|---|---|---|---|---|---|
| `podcasts` | `/podcasts` | ⬜ planned | landing | anonymous | — |
| `podcasts.trending` | `/podcasts/trending` | ⬜ planned | article | anonymous | — |
| `podcasts.latest` | `/podcasts/latest` | ⬜ planned | article | anonymous | — |
| `podcasts.categories` | `/podcasts/categories` | ⬜ planned | article | anonymous | — |
| `podcasts.detail` | `/podcasts/:slug` | ⬜ planned | player | anonymous | — |
| `podcasts.transcript` | `/podcasts/:slug/transcript` | 🟡 partial | player | anonymous | — |
| `podcasts.chapters` | `/podcasts/:slug/chapters` | ⬜ planned | player | anonymous | — |
...
| `research.publications` | `/research/publications` | ⬜ planned | article | anonymous | — |
| `research.papers` | `/research/papers` | ⬜ planned | article | anonymous | — |
| `research.datasets` | `/research/datasets` | 🟡 partial | article | anonymous | — |
...
| `research.citations` | `/research/citations` | ⬜ planned | article | anonymous | — |
| `research.downloads` | `/research/downloads` | ⬜ planned | article | anonymous | — |
...
| `academy.courses` | `/academy/courses` | ⬜ planned | article | anonymous | academy |
| `academy.course` | `/academy/course/:slug` | ⬜ planned | reader | anonymous | academy |
| `academy.lessons` | `/academy/lessons` | ⬜ planned | article | anonymous | academy |
| `academy.quizzes` | `/academy/quizzes` | ⬜ planned | article | anonymous | academy |
| `academy.tests` | `/academy/tests` | ⬜ planned | article | anonymous | academy |
...
| id | path | status | layout | permissions | flags |
|---|---|---|---|---|---|
| `events` | `/events` | ⬜ planned | landing | anonymous | events |
| `events.live` | `/events/live` | ⬜ planned | article | anonymous | events |
| `events.upcoming` | `/events/upcoming` | ⬜ planned | article | anonymous | events |
| `events.calendar` | `/events/calendar` | ⬜ planned | article | anonymous | events |
| `events.workshops` | `/events/workshops` | ⬜ planned | article | anonymous | events |
| `events.webinars` | `/events/webinars` | ⬜ planned | article | anonymous | events |
| `events.hackathons` | `/events/hackathons` | ⬜ planned | article | anonymous | events |
| `events.science-fairs` | `/events/science-fairs` | ⬜ planned | article | anonymous | events |

## 📰 News

| id | path | status | layout | permissions | flags |
|---|---|---|---|---|---|
| `news` | `/news` | ⬜ planned | article | anonymous | — |
| `news.science` | `/news/science` | ⬜ planned | article | anonymous | — |
| `news.space` | `/news/space` | ⬜ planned | article | anonymous | — |
| `news.technology` | `/news/technology` | ⬜ planned | article | anonymous | — |
| `news.agriculture` | `/news/agriculture` | ⬜ planned | article | anonymous | — |
| `news.india` | `/news/india` | ⬜ planned | article | anonymous | — |
| `news.world` | `/news/world` | ⬜ planned | article | anonymous | — |
...
| `ai.transcript` | `/ai/transcript` | 🟡 partial | reader | anonymous | — |
